...
import { OAuthError, Scopes, OAuthIssuer, OAuthClient, OAuthOptions, AccessToken, RefreshToken, OAuthConfig, OAuthProvider, Credentials } from 'mosaic';
...
declare class GoogleAuthError extends OAuthError {
...
declare class Auth {
    ...
    static issueToken(androidId: string, app: AndroidApp, refreshToken: string, scopes: Scopes): Promise<{
        secret: string;
...
type index_AndroidApp = AndroidApp;
type index_Auth = Auth;
declare const index_Auth: typeof Auth;
type index_DeviceConfig = DeviceConfig;
type index_GoogleAuthError = GoogleAuthError;
declare const index_GoogleAuthError: typeof GoogleAuthError;
type index_GoogleAuthErrors = GoogleAuthErrors;
declare const index_GoogleAuthErrors: typeof GoogleAuthErrors;
type index_GoogleAuthService = GoogleAuthService;
declare const index_checkin: typeof checkin;
declare const index_createAndroidId: typeof createAndroidId;
declare namespace index {
  export {
    index_AndroidApp as AndroidApp,
    index_Auth as Auth,
    index_DeviceConfig as DeviceConfig,
    index_GoogleAuthError as GoogleAuthError,
    index_GoogleAuthErrors as GoogleAuthErrors,
    index_GoogleAuthService as GoogleAuthService,
    index_checkin as checkin,
    index_createAndroidId as createAndroidId,
  };
}
...
declare class AndroidOAuth extends OAuthIssuer {
    ...
    private login;
    private issue;
    perform(client: OAuthClient, scopes: Scopes, options?: OAuthOptions): Promise<AccessToken>;
    exchange(code: string, client: OAuthClient): Promise<AccessToken>;
    refresh(access: AccessToken, refresh: RefreshToken): Promise<AccessToken>;
    revoke(access: AccessToken): Promise<void>;
}

interface GoogleCloudServiceConfig {
    id: string;
    defaultHost?: string;
}
...
declare class ProjectRegistry {
    ...
    registerProjects(projects: GoogleCloudProject[]): void;
    getProject(name: string): GoogleCloudProject;
}
declare const DefaultProjectRegistry: ProjectRegistry;

declare class GoogleCookie extends Credentials {
    private cookies;
    private string;
...
export { AndroidOAuth, DefaultProjectRegistry, GoogleCloudProject, GoogleCloudServiceConfig, GoogleCookie, GoogleOAuthClient, index as MobileServices, ProjectRegistry };
